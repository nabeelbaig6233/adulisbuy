        ...
        <div class="row">
                        ...
                        <div class="slider-banner">
                            <div class="slider-img">
                                <ul class="layout2-slide-1">
                                    <li id="img-1"><img src="{{asset('assets/front/images/')}}/layout-1/slider/1.1.png" class="img-fluid" alt="slider"></li>
                                </ul>
                            </div>
                        ...
                        <div class="slider-banner">
                            <div class="slider-img">
                                <ul class="layout2-slide-2">
                                    <li id="img-2"><img src="{{asset('assets/front/images/')}}/layout-1/slider/1.2.png" class="img-fluid" alt="slider"></li>
                                </ul>
                            </div>
                            <div class="slider-banner-contain">
                                <div>
                        ...
                        <div class="slider-banner">
                            <div class="slider-img">
                                <ul class="layout2-slide-3">
                                    <li id="img-3"><img src="{{asset('assets/front/images/')}}/layout-1/slider/1.3.png" class="img-fluid" alt="slider"></li>
                                </ul>
                            </div>
                            <div class="slider-banner-contain">
                                <div>
            ...
            <div class="col-xl-2 col-sm-3 pl-0 offer-banner">
                <div class="offer-banner-img">
                    <img src="{{asset('assets/front/images/')}}/layout-1/offer-banner.png" alt="offer-banner" class="img-fluid  ">
                </div>
    ...
    <div class="custom-container">
        <div class="row collection collection-layout1">
            <div class="col-md-4 offset-xl-2 p-r-md-0">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="{{asset('assets/front/images/')}}/layout-1/collection-banner/1.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
            ...
            <div class="col-md-4 col-4">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="{{asset('assets/front/images/')}}/layout-1/collection-banner/2.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>hand</h3>
            ...
            <div class="col-md-2  pl-md-0">
                <div class="collection-banner-main p-top banner-6">
                    <div class="collection-img">
                        <img src="{{asset('assets/front/images/')}}/layout-1/collection-banner/7.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h6>10% off</h6>
                ...
                <div class="slide-1   no-arrow">
                    <div>
                        <div class="media-banner">
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/media-banner/1.jpg" class="img-fluid  " alt="banner">
                                    <div class="media-body">
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/media-banner/2.jpg" class="img-fluid  " alt="banner">
                                    <div class="media-body">
                                        <div class="media-contant">
                                            <div>
                                                <div class="rating">
                    ...
                    <div>
                        <div class="media-banner">
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/media-banner/3.jpg" class="img-fluid  " alt="banner">
                                    <div class="media-body">
                                        <div class="media-contant">
                                            <div>
                                                <div class="rating">
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/media-banner/4.jpg" class="img-fluid  " alt="banner">
                                    <div class="media-body">
                                        <div class="media-contant">
                                            <div>
                                                <div class="rating">
                                    ...
                                    <div class="row hot-deal-subcontain">
                                        <div class="col-lg-4 col-sm-4 col-12">
                                            <div class="hotdeal-right-slick-1 no-arrow">
                                                <div class="right-slick-img"><img src="{{asset('assets/front/images/')}}/layout-1/hot-deal/1.jpg" alt="hot-deal" class="img-fluid  "></div>
                                                <div class="right-slick-img"><img src="{{asset('assets/front/images/')}}/layout-1/hot-deal/2.jpg" alt="hot-deal" class="img-fluid  "></div>
                                                <div class="right-slick-img"><img src="{{asset('assets/front/images/')}}/layout-1/hot-deal/3.jpg" alt="hot-deal" class="img-fluid  "></div>
                                                <div class="right-slick-img"><img src="{{asset('assets/front/images/')}}/layout-1/hot-deal/4.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-sm-2 p-l-md-0">
                                            <div class="hotdeal-right-nav-1">
                                                <div><img src="{{asset('assets/front/images/')}}/layout-1/hot-deal/1.jpg" alt="hot-deal" class="img-fluid  " ></div>
                                                <div><img src="{{asset('assets/front/images/')}}/layout-1/hot-deal/2.jpg" alt="hot-deal" class="img-fluid  " ></div>
                                                <div><img src="{{asset('assets/front/images/')}}/layout-1/hot-deal/3.jpg" alt="hot-deal" class="img-fluid  " ></div>
                                                <div><img src="{{asset('assets/front/images/')}}/layout-1/hot-deal/4.jpg" alt="hot-deal" class="img-fluid  " ></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="container-fluid">
        <div class="row collection2">
            <div class="col-md-4">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="{{asset('assets/front/images/')}}/layout-1/collection-banner/3.jpg" class="img-fluid bg-img " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>classic</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="{{asset('assets/front/images/')}}/layout-1/collection-banner/4.jpg" class="img-fluid bg-img " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>food</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="{{asset('assets/front/images/')}}/layout-1/collection-banner/5.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>digital</h3>
                            ...
                            <div class="product-slide-6 product-m no-arrow">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <img src="{{asset('assets/front/images/')}}/layout-1/product/8.jpg" class="img-fluid"   alt="product">
                                            </div>
                                            <div class="product-back">
                                                <img src="{{asset('assets/front/images/')}}/layout-1/product/a8.jpg" class="img-fluid  " alt="product">
                                            </div>
                                            <div class="product-icon">
                                                <button  onclick="openCart()" type="button" >
                                                    <i class="fa fa-shopping-bag" ></i>
                ...
                <div class="slide-6 no-arrow">
                        ...
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/rounded-cat/1.png" alt="category" class="img-fluid">
                                </div>
                                <div>
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/rounded-cat/2.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        Furniture
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/rounded-cat/3.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        Bag
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/rounded-cat/4.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        Tools
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/rounded-cat/5.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        Grocery
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/rounded-cat/6.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        camera
                    ...
                    <div>
                        <div class="category-contain">
                            <a href="#">
                                <div class="img-wrapper">
                                    <img src="{{asset('assets/front/images/')}}/layout-1/rounded-cat/7.png" alt="category" class="img-fluid  ">
                                </div>
                                <div>
                                    <div class="btn-rounded">
                                        cardigans
                ...
                <div class="blog-slide no-arrow">
                    <div >
                        <div class="blog-contain">
                            <div class="blog-img">
                                <img src="{{asset('assets/front/images/')}}/layout-1/blog/1.jpg" alt="blog" class="img-fluid  w-100">
                            </div>
                    ...
                    <div>
                        <div class="blog-contain">
                            <div class="blog-img">
                                <img src="{{asset('assets/front/images/')}}/layout-1/blog/2.jpg" alt="blog" class="img-fluid w-100 ">
                            </div>
                            <div class="blog-details">
                                <h4>Latest News Post</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eleifend a massa rhoncus gravida.</p>
                    ...
                    <div>
                        <div class="blog-contain">
                            <div class="blog-img">
                                <img src="{{asset('assets/front/images/')}}/layout-1/blog/3.jpg" alt="blog" class="img-fluid w-100 ">
                            </div>
                            <div class="blog-details">
                                <h4>Latest News Post</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur eleifend a massa rhoncus gravida.</p>
                ...
                <div class="slide-1 no-arrow">
                        ...
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{asset('assets/front/images/')}}/testimonial/1.jpg" class="img-fluid rounded-circle " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                    ...
                    <div>
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{asset('assets/front/images/')}}/testimonial/2.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                    ...
                    <div>
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{asset('assets/front/images/')}}/testimonial/3.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                    ...
                    <div class="slide-7 no-arrow">
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/1.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/2.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/3.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/4.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/5.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/6.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/7.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/8.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/9.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/10.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/11.jpg" class="img-fluid    " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/12.jpg" class="img-fluid    " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/13.jpg" class="img-fluid    " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('assets/front/images/')}}/insta/14.jpg" class="img-fluid    " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram" ></i>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col">
                <div class="contact-banner-contain">
                    <div class="contact-banner-img"><img src="{{asset('assets/front/images/')}}/layout-1/call-img.png" alt="call-banner"></div>
