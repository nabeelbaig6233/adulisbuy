                    ...
                    <tr>
                        ...
                        <td><a href="#">cotton shirt</a>
                            <div class="mobile-cart-content row">
                                ...
                                <div class="col-xs-3">
                                    <h2 class="td-color"><a href="#" class="icon mr-1"><i class="fa fa-times"></i> </a><a href="#" class="cart"><i class="fa fa-shopping-cart"></i></a></h2></div>
                            </div>
                        </td>
                        <td>
                            <h2>$63.00</h2></td>
                        ...
                        <td><a href="#" class="icon mr-3"><i class="fa fa-times"></i> </a><a href="#" class="cart"><i class="fa fa-shopping-cart"></i></a></td>
                    </tr>
                    </tbody>
                    <tbody>
                    <tr>
