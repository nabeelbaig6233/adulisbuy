    ...
    <section class="about-page section-big-py-space">
        <div class="custom-container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <h4>Where Sellers and Buyers Meet Supreme Convenience</h4>
                    <p class="mb-2">Adulisbuy is an e-commerce company that prides itself on supporting small businesses to thrive in an encouraging environment. As we strive to provide a platform for small businesses to stand out from their competition, we have become precedent-setting e-commerce retail and B2B marketplace in the country. </p>
                    <p class="mb-2">The motivation behind creating Adulisbuy was to provide a platform that empowers small businesses by giving them a voice. From day one of starting our operations, we have remained committed to ensuring that the sellers are enabled to take complete control of their marketing voice and express it as wildly as possible through our platform.</p>
                    <p class="mb-2">Our model for supporting small businesses, manufacturing companies, industries, and individuals is to cut out the middleman so that both the seller and buyer get more value. After all, it comes down to value, and that’s exactly what we aim to achieve.</p>
                    <p class="mb-2">At Adulisbuy, we are dedicated to providing reliable buying options for our buyers and we ensure it by coordinating with our sellers and having stringent checks on the quality of products. By giving our sellers and buyers an impeccable platform and highly reliable support, we are operating with a simple purpose: to become the most reliable platform for sellers and buyers. </p>
                </div>
                <div class="col-lg-6">
                    <div class="about_page01">
                        <h4>Our Vision</h4>
                        <p class="mb-2">Adulisbuy envisions its success in transforming the infrastructure of commerce to provide more value to sellers and buyers.</p>
                        <h4>Our Mission</h4>
                        <p class="mb-2">The mission of Adulisbuy is to help small businesses grow and provide reliable buying options to customers. We aim to build stronger connections between buyers and sellers with secure and satisfying experiences.</p>
                        <h4>Our Values</h4>
                        <p class="mb-2">At Adulisbuy, we firmly believe that our values dictate us. After all, we were able to lay a strong foundation for our company based on these 6 unwavering values.</p>
                        <ul>
                            <li>Innovation</li>
                            <li>Transparency</li>
                            <li>Dedication</li>
