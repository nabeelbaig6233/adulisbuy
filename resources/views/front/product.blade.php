                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    @if ($product->multi_image)
                                        <?php $multi_image = json_decode($product->multi_image); ?>
                                        <div class="product-slick ">
                                            @foreach($multi_image as $multiImage)

                                                <div><img src="{{asset($multiImage)}}" alt="" class="img-fluid  image_zoom_cls-0"></div>
                                            @endforeach
                                        </div>
                                        <div class="row">
                                ...
                                <div class="product-box">
                                    ...
                                    <div class="product-detail detail-center ">
                                        ...
                                        <div class="icon-detail">
                                            ...
                                            <button href="javascript:void(0)" title="Add to Wishlist">
